    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gallery_id', shortuuid.django_fields.ShortUUIDField(alphabet='1234567890', length=10, max_length=10, prefix='')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_id', shortuuid.django_fields.ShortUUIDField(alphabet='123456789', length=22, max_length=25, prefix='')),
                ('date', models.DateTimeField(default=django.utils.timezone.now)),
            ],
            options={
                'ordering': ['-date'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.TextField(blank=True, choices=[(1, '★✰✰✰✰'), (2, '★★✰✰✰'), (3, '★★★✰✰'), (4, '★★★★✰'), (5, '★★★★★')], default=None, null=True)),

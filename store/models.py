...
class Gallery (models.Model):
    ...
    gallery_id = ShortUUIDField(length=10,max_length=10, alphabet="1234567890")
...
class OrderItem (models.Model):
    ...
    item_id = ShortUUIDField(max_length=25,alphabet="123456789")
...
class Review(models.Model):
    ...
    rating = models.TextField(choices=RATING, default=None,blank=True,null=True)
